...
test('CSS Stylesheet - Mobile Modal Responsive View (iPhone 17e Baseline)', async () => {
  ...
  assert(cssContent.includes('height: calc(100dvh - 120px);'), 'Mobile modal should set fixed height with calc(100dvh - 120px)');
  assert(cssContent.includes('max-height: calc(100dvh - 120px);'), 'Mobile modal should constrain max-height with calc(100dvh - 120px)');
