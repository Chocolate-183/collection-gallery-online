...
test('CSS Stylesheet - Desktop Modal 10:16 Aspect Ratio Size', async () => {
  ...
  assert(cssContent.includes('aspect-ratio: 10 / 16;'), 'Should define 10:16 aspect ratio for desktop modal size');
