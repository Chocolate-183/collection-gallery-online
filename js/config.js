...
export const collectionsConfig = {
  'japanese-terms': {
    ...
    defaultMeta: {
      ...
      subtitle: '典藏日本流行與次文化用語的數位展廳',
      description: '本展廳精心策展並典藏豐富的日本文化特色詞彙、生活慣用語、流行新詞與次文化用語。展區特別規劃 50 音快速索引，並提供完整的平假名標音對照，邀請您細細品味每個展品詞彙背後的文化意涵。',
      notice: '1. 典藏標準：\n   - 排除日文與台灣中文表達方式完全相同的詞彙。\n   - 排除含有純假名構成的詞彙。\n\n2. 觀展建議：本展區適合作為日文學習者的進階參考典藏，協助深層理解道地的日本文化與用語細節。',
      author: '巧克力 (策展人)'
    }
  },
  'china-terms': {
    ...
    defaultMeta: {
      ...
      notice: '典藏詞彙可能因地區或時間演變有所變化，僅供參觀研究參考。',
      author: '巧克力 (策展人)'
    }
  }
};
