...
本專案為通用型線上展覽與主題展品檢索網頁應用程式（Collection Gallery Online 平台），提供多展廳動態切換、各展廳獨立策劃與負責人資訊、經營團隊服務台（Info）、試營運 (Beta) 標籤、開館時間與維護模式管理、獨立大廳、動態展品卡片矩陣、多維度動態篩選排序與展品導覽彈窗 (Modal)。
